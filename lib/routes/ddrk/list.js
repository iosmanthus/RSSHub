...
module.exports = async (ctx) => {
    const url = ctx.params.tag ? `https://ddys.pro/tag/${encodeURIComponent(ctx.params.tag)}/` : ctx.params.category ? `https://ddys.pro/category/${ctx.params.category}/` : 'https://ddys.pro/';
